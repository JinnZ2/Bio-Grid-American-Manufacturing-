...
> `docs/Economic_Impact.md`, preserved for provenance only. Several of its
> quantitative claims were withdrawn as unsupportable — see
> [../../../docs/SCIENCE_UPDATE_2026.md](../../../docs/SCIENCE_UPDATE_2026.md).
>
> **Current version:** [../../../docs/Economic_Impact.md](../../../docs/Economic_Impact.md)
>
> Archived from commit `fb07207`. This banner is the only modification;
> the byte-exact original is `git show fb07207:docs/Economic_Impact.md`.
